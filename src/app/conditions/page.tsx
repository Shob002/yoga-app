...
export default function ConditionsPage() {
  return (
    <main className="relative min-h-screen overflow-hidden bg-[#050706] text-[#f7efe0]">
      ...
      >
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_15%_5%,rgba(214,179,106,0.12),transparent_30%),radial-gradient(circle_at_85%_35%,rgba(45,107,75,0.18),transparent_32%),linear-gradient(180deg,#050706_0%,#0a110d_55%,#050706_100%)]" />
      </div>

      {/* =========================================================
          HERO
      ========================================================= */}
      <section className="px-6 pb-20 pt-20 sm:pt-24 md:pb-28 md:pt-28">
        <div className="mx-auto max-w-7xl">
          {/* Back to Home */}
          <Link
            href="/"
            className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/[0.04] px-5 py-2.5 text-xs font-bold uppercase tracking-[0.2em] text-[#d6b36a] transition-all duration-300 hover:border-[#d6b36a]/40 hover:bg-white/[0.08]"
          >
          ...
          <div className="mt-14 max-w-5xl md:mt-20">
            ...
            <h1 className="mt-6 text-[clamp(3rem,7vw,7rem)] font-black leading-[0.9] tracking-[-0.07em] text-[#f7efe0]">
              Care for your
      ...
      {/* =========================================================
          CONDITIONS
      ========================================================= */}
      <section className="border-y border-white/10 bg-white/[0.02] px-6 py-20 md:py-28">
        <div className="mx-auto max-w-7xl">
          ...
          <div className="grid gap-5 md:grid-cols-2 lg:grid-cols-3">
            {conditions.map((condition) => {
              ...
              return (
                <article
                  key={condition.title}
                  className="group rounded-[2rem] border border-white/10 bg-[#0b120e]/80 p-7 transition-all duration-300 hover:-translate-y-1 hover:border-[#d6b36a]/30 hover:bg-[#101913] hover:shadow-[0_20px_60px_rgba(0,0,0,0.25)]"
                >
                  {/* Icon */}
                  ...
                  <Link
                    href="/booking"
                    className="mt-7 inline-flex items-center gap-2 text-xs font-bold uppercase tracking-[0.15em] text-[#d6b36a] transition-colors hover:text-[#f2d89a]"
                  >
                    Learn More
                    <ArrowRight
      ...
      <section className="px-6 py-20 md:py-28">
        <div className="mx-auto grid max-w-7xl gap-12 lg:grid-cols-2 lg:items-center">
          ...
          <div>
            ...
            <h2 className="mt-5 text-4xl font-black leading-[0.95] tracking-[-0.06em] text-[#f7efe0] md:text-6xl">
            ...
            <Link
              href="/booking"
              className="group mt-9 inline-flex items-center gap-3 rounded-full bg-[#d6b36a] px-7 py-4 text-sm font-bold uppercase tracking-[0.15em] text-[#050706] transition-all duration-300 hover:-translate-y-1 hover:bg-[#e2c47e] hover:shadow-[0_0_50px_rgba(214,179,106,0.3)]"
            >
              Start Assessment
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            {approachSteps.map((step) => (
              <div
                key={step.number}
                className="rounded-[2rem] border border-white/10 bg-[#0b120e] p-7 transition-all duration-300 hover:border-[#d6b36a]/20 hover:bg-[#0f1712]"
              >
      ...
      <section className="px-6 pb-20 md:pb-28">
        <div className="mx-auto max-w-6xl rounded-[3rem] border border-[#d6b36a]/20 bg-[#111a14] p-8 text-center shadow-[0_0_100px_rgba(0,0,0,0.4)] md:p-16">
          ...
          <Link
            href="/booking"
            className="mt-9 inline-flex items-center gap-3 rounded-full bg-[#d6b36a] px-8 py-5 text-sm font-bold uppercase tracking-[0.18em] text-[#050706] transition-all duration-300 hover:-translate-y-1 hover:bg-[#e2c47e] hover:shadow-[0_0_60px_rgba(214,179,106,0.35)]"
          >
            Book Yoga Therapy
      ...
      <section className="px-6 pb-16 md:pb-20">
        <div className="mx-auto max-w-5xl rounded-[2rem] border border-white/10 bg-white/[0.02] p-7 text-center">
          ...
          <p className="mt-4 text-sm leading-7 text-[#7f8c83]">
            ...
            replace diagnosis, prescribed treatment, or emergency medical
            care. Individual suitability should be assessed before beginning
