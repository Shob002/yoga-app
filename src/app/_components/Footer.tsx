        ...
        <div className="grid gap-12 md:grid-cols-4">
          ...
          <div>
            <Link href="/" className="flex items-center gap-3">
              ...
              <div className="flex h-12 w-12 items-center justify-center rounded-full bg-gradient-to-br from-[#d6b36a] to-[#7bae8a]">
            ...
            <p className="mt-6 max-w-xs text-sm leading-7 text-[#b8c4ba]">
              Evidence-based yoga therapy integrating
              breath, movement, meditation and lifestyle
              transformation.
            </p>
          ...
          <div>
            ...
            <p className="text-sm leading-7 text-[#b8c4ba]">
              Join online yoga therapy sessions
              from anywhere.
            </p>
