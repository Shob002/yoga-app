      ...
      <div className="relative mx-auto max-w-7xl">
        ...
        >
          ...
          <h2 className="mt-5 max-w-5xl text-[clamp(2.5rem,5vw,5rem)] font-black leading-[0.95] tracking-[-0.05em]">
            Real Stories.
            <span className="text-[#7bae8a]"> Real Transformation.</span>
          </h2>
        ...
        <div className="mt-14 grid gap-6 md:grid-cols-3">
          {testimonials.map((item, index) => (
            ...
            >
              <div className="absolute right-8 top-8 text-[#d6b36a]/20">
              ...
              <div className="flex gap-1">
                {[1, 2, 3, 4, 5].map((star) => (
                  <Star
                    key={star}
                    className="h-5 w-5 fill-[#d6b36a] text-[#d6b36a]"
                  />
                ))}
              </div>
              ...
              <div className="mt-8 flex items-center gap-4">
                <div className="flex h-12 w-12 items-center justify-center rounded-full bg-gradient-to-br from-[#d6b36a] to-[#7bae8a] font-black text-[#050706]">
                  {item.name.charAt(0)}
                </div>
                ...
                <div>
                  ...
                  <p className="text-sm text-[#7f8f84]">{item.role}</p>
                </div>
              </div>
            </motion.div>
          ))}
